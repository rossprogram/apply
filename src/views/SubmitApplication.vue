<template>
  <v-container fluid>
    <v-row v-if="errorsAndWarnings.length > 0"
      ><v-col
        ><v-card>
          <v-card-title>Errors and Warnings</v-card-title>
          <v-list-item two-line v-for="item in errorsAndWarnings" :key="item.error" :to="item.to">
            <v-list-item-icon>
          ...
          <v-card-text v-if="errorsAndWarnings.filter((r) => r.severity !== 'warning').length > 0">
            ...
            <p>
              These errors have prevented you from being able to submit your application. A comment
              will state what required information is missing. Warnings are suggestions for
              improving your application, but will not block the submission.
            </p>
            <p>
              You do <strong>not</strong> have to wait for your recommendation letter to be received
      ...
      ></v-row
    >
    <v-row v-if="errorsAndWarnings.filter((r) => r.severity !== 'warning').length == 0"
      ><v-col
        ><v-card>
          <v-card-title>Submit your application</v-card-title>
          <v-card-subtitle
            ><p>
              When you have submitted all the material you would like the Admissions Committee to
              evaluate, you may submit your application below.
            </p>
            <p>
              You do <strong>not</strong> have to wait for your recommendation letter to be received
              before you submit your application.
            ...
            <p>
              After you click the blue &ldquo;Submit your Application&rdquo; button, the system
              might respond with a list of Errors and Warnings. Errors will stop your submission. A
              comment will state what required information is missing. Warnings are suggestions for
              improving your application, but will not block the submission.
            </p>
            <p>
              After your application has been submitted successfully, you may view (but not change)
              your submitted materials using the menu on the left.
            </p>
            <p>
              The red &ldquo;Withdraw your Application&rdquo; button allows you to undo your
              submission. All materials you typed and uploaded will remain, allowing you to edit
              those materials as you choose. Then you may click &ldquo;Submit your
              Application&rdquo; as before.
            </p>
            <p>
    ...
    <v-row v-if="application.submitted"
      ><v-col
        ><v-card>

<template>
  <v-form :key="key">
    <p>We invite you to submit your application to be a student at the Ross Mathematics Program.</p>

    <v-layout wrap>
      <v-flex xs12 md12>
        <v-checkbox v-model="juniorCounselor">
    ...
    <p>
      There are multiple locations for the Ross Program, and this single application is used for all
      locations.
    </p>

    <p>
      To enter or upload your application information, click on the menu items to the left. Files
      are saved according to the email address you entered when setting up the account. Please use
      an email that will remain valid at least through August {{ new Date().getFullYear() }}.
    </p>

    <p>
      As you finish each section, please click "Save" or "Save Application." Later when you log in
      again, the information will remain and you may continue working on your application. After you
      submit a completed application you may withdraw it, edit your entries, and then submit again.
    </p>
